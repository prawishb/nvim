...
vim.keymap.set("n", "<C-h>", ":wincmd h<CR>", default_opts, { desc = "Move to left window" })
vim.keymap.set("n", "<C-l>", ":wincmd l<CR>", default_opts, { desc = "Move to right window" })
vim.keymap.set("n", "<C-j>", ":wincmd j<CR>", default_opts, { desc = "Move to bottom window" })
vim.keymap.set("n", "<C-k>", ":wincmd k<CR>", default_opts, { desc = "Move to upper window" })
